...
const DES::BytesContainer DES::rot_table = {1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1};

// First table : initial permutation.
const DES::SBox DES::IP = {
...
// Substitution tables.
const std::vector<DES::SBox> DES::S = {
   {
...
const DES::UInt64Container DES::getKeySchedule()
{
   ...
   for (uint8_t i = 0; i < 16; ++i)
   {
      ...
      sub_keys.push_back(getBitsFromTable(K, PC2, 56, 48));
   }
