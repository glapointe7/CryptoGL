...
namespace CryptoGL
{
    ...
    private:
        ...
        void inverseMixUp(const uint8_t index, const uint8_t key_index);
        void inverseMash(const uint8_t index);

        static constexpr std::array<uint8_t, 256> PI_TABLE = {{
        ...
        static constexpr std::array<uint8_t, 4> MIXUP_ROTATIONS = {{1, 2, 3, 5}};
    };
}
