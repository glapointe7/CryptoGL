...
namespace CryptoGL
{
    ...
    private:
        ...
        /* Specific padding rule of the Merkle-Damgard construction for 64 and 128 bits blocks. */
        BytesVector pad(BytesVector message) const override
        {
            ...
            const uint8_t padded_message_size = ((InputBlockSize * 2) - rest - (message.size() % InputBlockSize)) % InputBlockSize;
