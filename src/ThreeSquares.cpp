...
const ThreeSquares::ClassicalType ThreeSquares::encode(const ClassicalType &clear_text)
{  
...
const ThreeSquares::ClassicalType ThreeSquares::decode(const ClassicalType &cipher_text)
{  
