...
const uint8_t AES::shift_indexes[16] = {
   0, 5, 10, 15, 4, 9, 14, 3, 8, 13, 2, 7, 12, 1, 6, 11
};

const uint8_t AES::inverse_shift_indexes[16] = {
   0, 13, 10, 7, 4, 1, 14, 11, 8, 5, 2, 15, 12, 9, 6, 3
};

const uint32_t AES::round_constants[15] = {
   0x01000000, 0x02000000, 0x04000000, 0x08000000, 0x10000000, 0x20000000, 0x40000000, 0x80000000,
   0x1B000000, 0x36000000, 0x6C000000, 0xD8000000, 0xAB000000, 0x4D000000, 0x9A000000
};

const uint8_t AES::table_9[256] = {
...
const uint8_t AES::table_11[256] = {
...
const uint8_t AES::table_13[256] = {
...
const uint8_t AES::table_14[256] = {
...
void AES::generateSubkeys()
{
   ...
   BigEndian32 *BE = new BigEndian32();
...
const AES::BytesContainer AES::getOutputBlock(const BytesContainer &block, const bool to_encode)
{
   ...
   output.reserve(16);
   BigEndian32 *Big = new BigEndian32();
   for(uint8_t i = 0; i < 4; ++i)
   {
      Big->toBytes(state[i]);
      const BytesContainer out = Big->getBytes();
