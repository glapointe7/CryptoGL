...
#include "../../pseudo_random_generator/common/PseudoRandomFunction.hpp"
#include "../../hash_functions/sha1/SHA1.hpp"

namespace CryptoGL
{
    class SEAL : public SynchronousStreamCipher<UInt32Vector, BigEndian32, 1024, BytesVector>,
