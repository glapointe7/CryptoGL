...
#include "../common/MerkleDamgardFunction.hpp"
#include <array>
...
namespace CryptoGL
{
    ...
    template <>
    struct RoundConstants<uint32_t> {
        static constexpr std::array<uint32_t, 64> CubicRootPrimes = {{
        ...
        static constexpr std::array<uint8_t, 6> A = {{6, 11, 25, 2, 13, 22}};
    };

    template <>
    struct RoundConstants<uint64_t> {
        static constexpr std::array<uint64_t, 80> CubicRootPrimes = {{
        ...
        static constexpr std::array<uint8_t, 6> Shifters = {{1, 8, 7, 19, 61, 6}};
        static constexpr std::array<uint8_t, 6> A = {{14, 18, 41, 28, 34, 39}};
    };
