...
namespace CryptoGL
{
    ...
    public:
        ...
        {
            _128bits = 16, _160bits = 20, _192bits = 24
        };

        enum class Version : uint8_t
        {
            tiger = 0x01, tiger2 = 0x80
        };
        ...
        Tiger(const HashSize output_size, const Version version)
            : MerkleDamgardFunction({REGISTER_A_CONSTANT, REGISTER_B_CONSTANT, REGISTER_C_CONSTANT}, 24, static_cast<uint8_t> (output_size))
        {
