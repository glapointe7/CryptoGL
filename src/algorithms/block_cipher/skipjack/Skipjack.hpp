...
namespace CryptoGL
{
    ...
    private:
        ...
        void applyRuleAOnBlock(const uint8_t round);
        void applyRuleBOnBlock(const uint8_t round);
        void applyInverseRuleAOnBlock(const uint8_t round);
        void applyInverseRuleBOnBlock(const uint8_t round);
