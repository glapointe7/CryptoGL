...
namespace CryptoGL
{
    ...
    private:
        ...
        void extendSubKeys18Rounds(const BytesVector &Ka, const BytesVector &key_left);
        void extendSubKeysNot18Rounds(const BytesVector &Ka, const BytesVector &key_left,
                                      const BytesVector &key_right, const BytesVector &Kb);
        
        /* Prewhitening phase from the spec. */
        void processPrewhiteningPhase(const BytesVector &Ka, const BytesVector &key_left, const BytesVector &key_right);
        ...
        static constexpr std::array<uint32_t, 256> SP1110 = {{
        ...
        /* SP_{0222} = (0, s_2(y), s_2(y), s_2(y)). */
        static constexpr std::array<uint32_t, 256> SP0222 = {{
        ...
        /* SP_{3033} = (s_3(y), 0, s_3(y), s_3(y)). */
        static constexpr std::array<uint32_t, 256> SP3033 = {{
        ...
        /* SP_{4404} = (s_4(y), s_4(y), 0, s_4(y)). */
        static constexpr std::array<uint32_t, 256> SP4404 = {{
