...
namespace CryptoGL
{
    ...
    private:
        static std::array<uint32_t, 48> Kr;
        static std::array<uint32_t, 192> Tm;
        static std::array<uint32_t, 192> Tr;
        ...
        static constexpr uint32_t F3(const uint32_t D, const uint32_t Km, const uint32_t Kr);
