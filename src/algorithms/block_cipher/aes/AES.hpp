...
namespace CryptoGL
{
    ...
    private:
        ...
        static constexpr std::array<uint8_t, 16> inverse_shift_indexes = {{
        ...
        static constexpr std::array<uint8_t, 256> table_2 = {{
        ...
        static constexpr std::array<uint8_t, 256> table_3 = {{
        ...
        static constexpr std::array<uint8_t, 256> table_9 = {{
        ...
        static constexpr std::array<uint8_t, 256> table_11 = {{
        ...
        static constexpr std::array<uint8_t, 256> table_13 = {{
        ...
        static constexpr std::array<uint8_t, 256> table_14 = {{
