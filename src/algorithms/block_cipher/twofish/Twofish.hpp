...
namespace CryptoGL
{
    ...
    private:
        ...
        /* 4x4 MDS matrix. */
        static constexpr std::array<std::array<uint8_t, 4>, 4> MDS = {{
            {{0x01, 0xEF, 0x5B, 0x5B}},
            {{0x5B, 0xEF, 0xEF, 0x01}},
            {{0xEF, 0x5B, 0x01, 0xEF}},
            {{0xEF, 0x01, 0xEF, 0x5B}}
        ...
        /* The 4x8 RS matrix. */
        static constexpr std::array<std::array<uint8_t, 8>, 4> RS = {{
        ...
        static constexpr std::array<std::array<uint8_t, 256>, 2> Q = {{
            {{
