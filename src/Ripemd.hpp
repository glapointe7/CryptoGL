...
protected:
   ...
   static constexpr uint32_t magic_numbers_big2[5] = {0x50A28BE6, 0x5C4DD124, 0x6D703EF3, 0x7A6D76E9, 0};
   
   static constexpr uint8_t word_selection1[80] = {
   ...
   static constexpr uint8_t word_selection2[80] = {
   ...
   static constexpr uint8_t left_shift1[80] = {
   ...
   static constexpr uint8_t left_shift2[80] = {
