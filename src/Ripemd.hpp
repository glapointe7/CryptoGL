...
namespace CryptoGL
{
    ...
    protected:
        ...
        static constexpr std::array<uint32_t, 5> MAGIC_NUMBERS_1 = {{
            0, 0x5A827999, 0x6ED9EBA1, 0x8F1BBCDC, 0xA953FD4E
        }};

        static constexpr std::array<uint32_t, 4> MAGIC_NUMBERS_2 = {{
            0x50A28BE6, 0x5C4DD124, 0x6D703EF3, 0
        }};

        static constexpr std::array<uint32_t, 5> MAGIC_NUMBERS_3 = {{
            0x50A28BE6, 0x5C4DD124, 0x6D703EF3, 0x7A6D76E9, 0
        }};

        static constexpr std::array<uint8_t, 80> WORD_SELECTIONS_1 = {{
        ...
        static constexpr std::array<uint8_t, 80> WORD_SELECTIONS_2 = {{
        ...
        static constexpr std::array<uint8_t, 80> LEFT_SHIFTS_1 = {{
        ...
        static constexpr std::array<uint8_t, 80> LEFT_SHIFTS_2 = {{
