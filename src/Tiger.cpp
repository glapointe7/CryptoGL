...
const uint64_t Tiger::IV[3] = {
   0x0123456789ABCDEF, 0xFEDCBA9876543210, 0xF096A5B4C3B2E187
};

const uint64_t Tiger::sbox[4][256] = {
...
const Tiger::BytesContainer Tiger::process(const BytesContainer &data, const uint8_t truncate_to)
{
   ...
   return getOutput(truncate_to, state);
}

const Tiger::BytesContainer Tiger128::encode(const BytesContainer &data)
{
   return process(data, 4);
}

const Tiger::BytesContainer Tiger160::encode(const BytesContainer &data)
{
   return process(data, 5);
}

const Tiger::BytesContainer Tiger192::encode(const BytesContainer &data)
{
   return process(data, 6);
}