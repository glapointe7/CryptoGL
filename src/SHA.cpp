...
/*template <class UInt>
const typename HashFunction<uint32_t, BigEndian32>::WordsContainer SHA<UInt>::round_constants = {
...
template <class UInt>
const typename HashFunction<uint64_t, BigEndian64>::DWordsContainer SHA<UInt>::first_cubic_root_primes = {
