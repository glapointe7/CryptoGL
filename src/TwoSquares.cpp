...
const TwoSquares::ClassicalType TwoSquares::encode(const ClassicalType &clear_text)
{  
...
const TwoSquares::ClassicalType TwoSquares::decode(const ClassicalType &cipher_text)
{  
