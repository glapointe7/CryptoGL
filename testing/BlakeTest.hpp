...
TEST_F(BlakeTest, encode512ShortText)
{
   ...
   EXPECT_EQ(hash, S->encode(clear_text.hexToBytes()).toHexString());
}
...
TEST_F(BlakeTest, encode384ShortText)
{
   ...
   EXPECT_EQ(hash, T->encode(clear_text.hexToBytes()).toHexString());
}
...
TEST_F(BlakeTest, encode256ShortText)
{
   ...
   EXPECT_EQ(hash, U->encode(clear_text.hexToBytes()).toHexString());
}
...
TEST_F(BlakeTest, encode224ShortText)
{
   ...
   EXPECT_EQ(hash, V->encode(clear_text.hexToBytes()).toHexString());
}
