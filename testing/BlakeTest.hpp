...
TEST_F(BlakeTest, encode512ShortText)
{
   ...
   EXPECT_EQ(hash, Vector::toHexString(S->encode(clear_text.hexToBytes())));
}
...
TEST_F(BlakeTest, encode384ShortText)
{
   ...
   EXPECT_EQ(hash, Vector::toHexString(T->encode(clear_text.hexToBytes())));
}
...
TEST_F(BlakeTest, encode256ShortText)
{
   ...
   EXPECT_EQ(hash, Vector::toHexString(U->encode(clear_text.hexToBytes())));
}
...
TEST_F(BlakeTest, encode224ShortText)
{
   ...
   EXPECT_EQ(hash, Vector::toHexString(V->encode(clear_text.hexToBytes())));
}
