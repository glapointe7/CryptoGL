...
protected:
   ...
   virtual void SetUp()
   {
      ...
      CTR = new Blowfish(Digest::getBytesFromHexDigest("603DEB1015CA71BE2B73AEF0857D77811F352C073B6108D72D9810A30914DFF4"), 
...
{
   const BytesVector clear_text = Digest::getBytesFromHexDigest("6BC1BEE22E409F96E93D7E117393172AAE2D8A571E03AC9C9EB76F"
