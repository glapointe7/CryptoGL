...
protected:
   ...
   virtual void SetUp()
   {
      ...
      CTR = new Blowfish(String::hexToBytes("603DEB1015CA71BE2B73AEF0857D77811F352C073B6108D72D9810A30914DFF4"), 
...
TEST_F(BlowfishTest, decode)
{
   ...
   EXPECT_EQ(Vector::toHexString(clear_text), Vector::toHexString(B->decode(String::hexToBytes("7D856F9A613063F2"))));
}
...
{   
   EXPECT_EQ("37363534333231204E6F77206973207468652074696D6520666F722000000000", 
           Vector::toHexString(CBC->decode(String::hexToBytes("6B77B4D63006DEE605B156E27403979358DEB9E7154616D959F1652BD5FF92CC"))));
}
...
{   
   EXPECT_EQ("37363534333231204E6F77206973207468652074696D6520666F722000000000", 
           Vector::toHexString(CFB->decode(String::hexToBytes("E73214A2822139CAF26ECF6D2EB9E76E3DA3DE04D1517200519D57A6C3384ECE"))));
}
...
{   
   EXPECT_EQ("37363534333231204E6F77206973207468652074696D6520666F722000000000", 
           Vector::toHexString(OFB->decode(String::hexToBytes("E73214A2822139CA62B343CC5B65587310DD908D0C241B2263C2CF80DA46FBB8"))));
}

TEST_F(BlowfishTest, encodeWithCTRMode)
{
   const BytesVector clear_text = String::hexToBytes("6BC1BEE22E409F96E93D7E117393172AAE2D8A571E03AC9C9EB76F"
   ...
   EXPECT_EQ("EF2CA093ECC80BD87DDC11D06DBCD38B3B5205EEDCCF58945B192755945003FC44B144F5DC1ACC5F14EACCA935125879FEED0C53019712B1B07438BA4C19C864", 
           Vector::toHexString(CTR->encode(clear_text)));
}
...
{   
   EXPECT_EQ("6BC1BEE22E409F96E93D7E117393172AAE2D8A571E03AC9C9EB76FAC45AF8E5130C81C46A35CE411E5FBC1191A0A52EFF69F2445DF4F9B17AD2B417BE66C3710", 
           Vector::toHexString(CTR->decode(String::hexToBytes("EF2CA093ECC80BD87DDC11D06DBCD38B3"
