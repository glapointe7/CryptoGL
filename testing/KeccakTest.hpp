...
TEST_F(KeccakTest, encodeShort224)
{
   ...
   BytesVector cipher = {0x1F, 0x87, 0x7C};
   
   EXPECT_EQ(hash, Vector::toHexString(S->encode(cipher)));
}
...
TEST_F(KeccakTest, encodeEmpty256)
{
   ...
   EXPECT_EQ(hash, Vector::toHexString(T->encode(BytesVector(0))));
}
...
TEST_F(KeccakTest, encodeShort256)
{
   ...
   EXPECT_EQ(hash, Vector::toHexString(T->encode(cipher)));
}
...
TEST_F(KeccakTest, encodeEmpty384)
{
   ...
   EXPECT_EQ(hash, Vector::toHexString(U->encode(BytesVector(0))));
}
...
TEST_F(KeccakTest, encodeShort384)
{
   ...
   EXPECT_EQ(hash, Vector::toHexString(U->encode(cipher)));
}
...
TEST_F(KeccakTest, encodeLong512)
{
   ...
   EXPECT_EQ(hash, Vector::toHexString(V->encode(digest.hexToBytes())));
}
...
TEST_F(KeccakTest, encodeEmpty512)
{
   ...
   EXPECT_EQ(hash, Vector::toHexString(V->encode(BytesVector(0))));
}
...
TEST_F(KeccakTest, encodeShort512)
{
   ...
   EXPECT_EQ(hash, Vector::toHexString(V->encode(cipher)));
}
