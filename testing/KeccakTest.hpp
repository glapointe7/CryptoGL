...
TEST_F(KeccakTest, encodeShort224)
{
   ...
   EXPECT_EQ(hash, S->encode(cipher).toHexString());
}
...
TEST_F(KeccakTest, encodeEmpty256)
{
   ...
   EXPECT_EQ(hash, T->encode(BytesVector()).toHexString());
}
...
TEST_F(KeccakTest, encodeShort256)
{
   ...
   EXPECT_EQ(hash, T->encode(cipher).toHexString());
}
...
TEST_F(KeccakTest, encodeEmpty384)
{
   ...
   EXPECT_EQ(hash, U->encode(BytesVector()).toHexString());
}
...
TEST_F(KeccakTest, encodeShort384)
{
   ...
   EXPECT_EQ(hash, U->encode(cipher).toHexString());
}
...
TEST_F(KeccakTest, encodeLong512)
{
   ...
   EXPECT_EQ(hash, V->encode(digest.hexToBytes()).toHexString());
}
...
TEST_F(KeccakTest, encodeEmpty512)
{
   ...
   EXPECT_EQ(hash, V->encode(BytesVector()).toHexString());
}
...
TEST_F(KeccakTest, encodeShort512)
{
   ...
   EXPECT_EQ(hash, V->encode(cipher).toHexString());
}
