...
TEST_F(SHA512_224Test, encodeNormalText)
{
   ...
   EXPECT_EQ(hash, SHA512_224::hexDigest(S->encode(SHA512_224::getBytesFromString(clear_text))));
}
...
TEST_F(SHA512_224Test, encodeEmptyText)
{
   ...
   EXPECT_EQ(hash, SHA512_224::hexDigest(S->encode(std::vector<uint8_t>(0))));
}
