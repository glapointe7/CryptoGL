...
protected:
   ...
   virtual void SetUp()
   {
      C128 = new Twofish(std::vector<uint8_t>(16, 0));
...
{
   EXPECT_EQ("9F589F5CF6122C32B6BFEC2F2AE8C35A", Digest::hexDigest(C128->encode(std::vector<uint8_t>(16, 0))));
}
...
{
   EXPECT_EQ("CFD1D2E5A9BE9CDF501F13B892BD2248", Digest::hexDigest(C192->encode(std::vector<uint8_t>(16, 0))));
}
...
{
   EXPECT_EQ("37527BE0052334B89F0CFCCAE87CFA20", Digest::hexDigest(C256->encode(std::vector<uint8_t>(16, 0))));
}
