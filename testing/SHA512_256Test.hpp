...
TEST_F(SHA512_256Test, encodeNormalText)
{
   ...
   EXPECT_EQ(hash, SHA512_256::hexDigest(S->encode(SHA512_256::getBytesFromString(clear_text))));
}
...
TEST_F(SHA512_256Test, encodeEmptyText)
{
   ...
   EXPECT_EQ(hash, SHA512_256::hexDigest(S->encode(std::vector<uint8_t>(0))));
}
