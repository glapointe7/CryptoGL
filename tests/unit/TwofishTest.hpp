...
#include "Test.hpp"
#include "../../src/algorithms/block_cipher/twofish/Twofish.hpp"
...
namespace UnitTests
{
    ...
    {
       compare("9F589F5CF6122C32B6BFEC2F2AE8C35A", C128->encode(BytesVector(16, 0)));
    }
    ...
    {
       compare("CFD1D2E5A9BE9CDF501F13B892BD2248", C192->encode(BytesVector(16, 0)));
    }
    ...
    {
       compare("37527BE0052334B89F0CFCCAE87CFA20", C256->encode(BytesVector(16, 0)));
    }
