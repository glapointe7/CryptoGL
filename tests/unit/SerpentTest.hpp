...
#include "Test.hpp"
#include "../../src/algorithms/block_cipher/serpent/Serpent.hpp"
...
namespace UnitTests
{
    ...
    {
    protected:
        Serpent *Set2_128bits, *Set4_Vector0_128bits, *Set4_Vector1_128bits;
        Serpent *Set2_192bits, *Set4_Vector0_192bits, *Set4_Vector1_192bits;
    ...
    TEST(SerpentDecodeECB128Bits_Set7_Vector0, SerpentTest)
    {
        const BytesVector cipher_text = String("00000000000000000000000000000000").hexToBytes();
        compare("DB16780F1BB72D40AA75C8AAF0B335DA", Set2_128bits->decode(cipher_text));
    }
    ...
    TEST(SerpentDecodeECB256Bits_Set2, SerpentTest)
    {
        const BytesVector clear_text = String("49672BA898D98DF95019180445491089").hexToBytes();
        compare("00000000000000000000000000000000", Set2_256bits->decode(clear_text));
    }
}