...
#include "Test.hpp"
#include "../../src/algorithms/classical/transposition/Transposition.hpp"
...
namespace UnitTests
{
    ...
    TEST(TranspositionRowsEncode, TranspositionRowsTest)
    {
       ...
       compare("LATILNUSTLRIPAAINUUOECTQRALPIASNTGMARMAONORENIOITEBEEJOTUUEORBLSGDDIEOSTXSXXXXXT", TR->encode(clear_text));
    }
