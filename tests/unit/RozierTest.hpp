...
#include "Test.hpp"
#include "../../src/algorithms/classical/vigenere/Vigenere.hpp"
...
namespace UnitTests
{
    ...
    TEST(RozierEncode, RozierTest) 
    {
      ...
      compare("DOMJYGVWWMEFKNTHRJJMHNCOCFBFWOQGTZELANPYBBYCSXJGGPSPQOXGDISAJUBFHETXWBTUUH", R->encode(clear_text));
