...
#include "Test.hpp"
#include "../../src/algorithms/classical/four_squares/FourSquares.hpp"
...
namespace UnitTests
{
    ...
    TEST(FourSquaresEncode, FourSquaresTest) 
    {
      ...
      compare("NIHVSMCKCKNJNLGQNVARXJKMHIFQHUQNIDNLJHANGKLKSBEMTEAMAAARNYPHOEHZSEERAKCCSR", P->encode(clear_text));
    }
