...
#include "Test.hpp"
#include "../../src/algorithms/classical/railfence/Railfence.hpp"
...
namespace UnitTests
{
    ...
    // "SPUPIEEI ALATCARTOEOLBOG LIREOLOANTBRODT ULAUNSGMONJUUSS TIIQNIRMREESTE NTAAITD"
       compare("TIIQNIRMREESTELIREOLOANTBRODTNTAAITDSPUPIEEIULAUNSGMONJUUSSALATCARTOEOLBOG", R->encode(clear_text));
    }
    ...
    TEST(RedefenceEncodeWithOffset, RedefenceTest)
    {
       ...
       compare("SLPRUOPOINEBEOITTIIENLRARTERTDAACROOBGIQIMESEULATNAGTOEJLUOSNLTUASAMINTUDS", R->encode(clear_text));
    }
