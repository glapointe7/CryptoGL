...
namespace UnitTests
{
    ...
    TEST(BlowfishECBEncode, BlowfishTest)
    {
       ...
       compare(StringTest("7D856F9A613063F2"), B->encode(clear_text).toHexString());
    }
    ...
    TEST(BlowfishCBCEncode, BlowfishTest)
    {
       ...
       compare(StringTest("6B77B4D63006DEE605B156E27403979358DEB9E7154616D959F1652BD5FF92CC"), CBC->encode(clear_text).toHexString());
    }
    ...
    {   
       ...
       compare(StringTest("37363534333231204E6F77206973207468652074696D6520666F722000000000"), 
    ...
    TEST(BlowfishCFBEncode, BlowfishTest)
    {
       ...
       compare(StringTest("E73214A2822139CAF26ECF6D2EB9E76E3DA3DE04D1517200519D57A6C3384ECE"), CFB->encode(clear_text).toHexString());
    }
    ...
    TEST(BlowfishOFBEncode, BlowfishTest)
    {
       ...
       compare(StringTest("E73214A2822139CA62B343CC5B65587310DD908D0C241B2263C2CF80DA46FBB8"), OFB->encode(clear_text).toHexString());
    }
    ...
    TEST(BlowfishCTREncode, BlowfishTest)
    {
       ...
       compare(StringTest("EF2CA093ECC80BD87DDC11D06DBCD38B3B5205EEDCCF58945B192755945003FC44B144F5DC1ACC5F14EACCA935125879FEED0C53019712B1B07438BA4C19C864"), 
    ...
    {   
       ...
       compare(StringTest("6BC1BEE22E409F96E93D7E117393172AAE2D8A571E03AC9C9EB76FAC45AF8E5130C81C46A35CE411E5FBC1191A0A52EFF69F2445DF4F9B17AD2B417BE66C3710"), 
