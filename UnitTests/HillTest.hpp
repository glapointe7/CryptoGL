...
namespace UnitTests
{
    ...
    TEST(HillEncode2X2, HillTest)
    {
       ...
       compare(StringTest("CMJBFEQJQJTXZHWDYAKJQOQFNNSUHDJUOUZHGMYPCKRJFBMHVBQQNIKJEKRCQDSQRSGANLWQZX"), H->encode(clear_text));
    }
    ...
    TEST(HillEncode3X3, HillTest)
    {
       ...
       compare(StringTest("DSRMNQXTJEABZRGJJIDXFFQNVNYZDFCGRFXJWYCFBWUBVHMNJXIAPMBXZELSVFHCNMJWXSWOSLJ"), H->encode(clear_text));
    }
