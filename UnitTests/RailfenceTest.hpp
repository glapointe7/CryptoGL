...
namespace UnitTests
{
    ...
    TEST(RailfenceEncodeNormalCase, RailfenceTest)
    {
       ...
       compare(StringTest("SPUPIEEIALATCARTOEOLBOGLIREOLOANTBRODTULAUNSGMONJUUSSTIIQNIRMREESTENTAAITD"), R->encode(clear_text));
    }
    ...
    TEST(RailfenceEncodeWithOffset, RailfenceTest)
    {
       ...
       compare(StringTest("IQIMESENLTUASAMINTUDSTIIENLRARTERTDULATNAGTOEJLUOSSLPRUOPOINEBEOITAACROOBG"), R->encode(clear_text));
    }
