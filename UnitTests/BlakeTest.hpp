...
namespace UnitTests
{
    ...
    TEST(BlakeEncode256BitsEmptyText, BlakeTest)
    {
       ...
       compare(hash, U->encode({}).toHexString());
    }
    ...
    TEST(BlakeEncode224BitsEmptyText, BlakeTest)
    {
       ...
       compare(hash, V->encode({}).toHexString());
    }
    ...
    TEST(BlakeEncode512BitsShortText, BlakeTest)
    {
       ...
       compare(hash, S->encode(clear_text.hexToBytes()).toHexString());
    }
    ...
    TEST(BlakeEncode384BitsShortText, BlakeTest)
    {
       ...
       compare(hash, T->encode(clear_text.hexToBytes()).toHexString());
    }
    ...
    TEST(BlakeEncode256BitsShortText, BlakeTest)
    {
       ...
       compare(hash, U->encode(clear_text.hexToBytes()).toHexString());
    }
    ...
    TEST(BlakeEncode224BitsShortText, BlakeTest)
    {
       ...
       compare(hash, V->encode(clear_text.hexToBytes()).toHexString());
    }
